...
# =============================================================================
# SYSTEM PROMPTS and PERSONA Detection - Imported from app.services.ai
# =============================================================================
# NOTE: All prompts and personas are now imported from app.services.ai.prompts:
# - PERSONA_PROMPTS (dict with pco, pcm, da, ml, general personas)
# - detect_persona(query) -> str (returns detected persona type)
# - SYSTEM_PROMPT_WITH_DATA (prompt with data context)
# - SYSTEM_PROMPT_TEMPLATE (fallback prompt with tools)
# - get_system_prompt(persona, tools, data_context) -> str

# NOTE: find_best_matching_tag and get_trend_icon are now imported from app.services.ai.tag_matching
