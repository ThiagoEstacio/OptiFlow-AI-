"""
API v2 Router - Enhanced API with new features
...
# Import all v1 endpoints (backward compatible)
...
api_router.include_router(version_info.router, prefix="/version", tags=["API Version Info"])

# V1 endpoints (backward compatible in V2)
...
api_router.include_router(metrics.router, tags=["Monitoring"])  # No prefix - metrics at /api/v2/metrics
