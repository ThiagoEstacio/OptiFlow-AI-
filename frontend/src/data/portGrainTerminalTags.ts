...
export const PORT_GRAIN_TERMINAL_TAGS: Tag[] = [
  // ===== TRUCK RECEPTION AREA (Área de Recebimento) =====
  {
    ...
    name: 'RCV_SCALE_01_WEIGHT',
    description: 'Truck Scale 1 - Weight',
    unit: 'kg',
    category: 'Reception',
    min_value: 0,
    max_value: 60000,
  ...
  },
  {
    ...
    name: 'RCV_SCALE_01_STATUS',
    description: 'Truck Scale 1 - Status (0=Empty, 1=Weighing, 2=Complete)',
    unit: 'state',
    category: 'Reception',
    min_value: 0,
    max_value: 2,
  ...
  },
  {
    ...
    name: 'RCV_SCALE_02_WEIGHT',
    description: 'Truck Scale 2 - Weight',
    unit: 'kg',
    category: 'Reception',
    min_value: 0,
    max_value: 60000,
  ...
  },
  {
    ...
    name: 'RCV_SCALE_02_STATUS',
    description: 'Truck Scale 2 - Status',
    unit: 'state',
    category: 'Reception',
    min_value: 0,
    max_value: 2,
  ...
  {
    id: 'RCV_QUEUE_COUNT',
    name: 'RCV_QUEUE_COUNT',
    description: 'Number of Trucks in Queue',
    unit: 'trucks',
    category: 'Reception',
    min_value: 0,
    max_value: 50,
  ...
  },
  {
    ...
    name: 'RCV_HOPPER_01_LEVEL',
    description: 'Reception Hopper 1 - Level',
    unit: '%',
    category: 'Reception',
    min_value: 0,
    max_value: 100,
  ...
  },
  {
    ...
    name: 'RCV_HOPPER_01_GATE',
    description: 'Reception Hopper 1 - Gate Opening',
    unit: '%',
    category: 'Reception',
    min_value: 0,
    max_value: 100,
  ...
  },
  {
    ...
    name: 'RCV_HOPPER_02_LEVEL',
    description: 'Reception Hopper 2 - Level',
    unit: '%',
    category: 'Reception',
    min_value: 0,
    max_value: 100,
